          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 space-y-4 border-border bg-card">
              ...
              <div>
                ...
                <p className="text-muted-foreground break-words">khushalshivade28@gmail.com</p>
              </div>
            </Card>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.subject} onValueChange={(value) => setFormData({ ...formData, subject: value })} required>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="ai-integration">AI Integration Project</SelectItem>
                    <SelectItem value="fullstack">Full Stack MERN App</SelectItem>
